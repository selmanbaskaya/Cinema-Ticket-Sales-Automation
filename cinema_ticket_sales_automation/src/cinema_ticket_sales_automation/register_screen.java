...
public class register_screen extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        username = String.valueOf(tf_user.getText());
        password = String.valueOf((pf_pass.getText()));
        
        database_code adduser = new database_code();
        
        if (tf_user.getText().trim().isEmpty() || pf_pass.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Do not leave empty space!!");
        }
        else{
            adduser.user_add(6, username, password);
        }
